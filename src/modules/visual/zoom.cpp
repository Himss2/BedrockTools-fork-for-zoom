...
constexpr std::string_view kNormalImageId =
    "bedrocktools.zoom.normal";

constexpr std::string_view kPressedImageId =
    "bedrocktools.zoom.pressed";
...
constexpr int kZoomImageWidth =
    256;

constexpr int kZoomImageHeight =
    256;
...
constexpr float kBaseButtonSize =
    56.0f;
...
constexpr int32_t kMaxPointers =
    8;
...
//
// Minecraft fills output first.
//
// We then:
//   1. read the Zoom pointer movement
//   2. remove only that pointer from the output event
//
...
// IMPORTANT:
//
// The original BedrockTools Zoom did one very important thing:
//
//     DOWN on Zoom  -> return true
//
// That prevents Minecraft from ever registering the Zoom finger as a camera
// pointer.
//
// We restore that behaviour here.
//
// MOVE is NOT globally consumed because ACTION_MOVE may contain several fingers.
// Raw GameActivityMotionEvent filtering removes only m_trackedPointerId.
//
    ...
    switch (action) {
        ...
        case kActionPointerDown:
        {
            ...
            if (
                ...
                // =============================================================
                //
                // Zoom finger belongs to the Zoom module.
                //
                // Do NOT forward this DOWN to Minecraft.
                //
                // Minecraft therefore cannot register it as camera touch.
                //
        ...
        case kActionMove:
        {
            ...
            // =============================================================
            //
            // One Android ACTION_MOVE can contain:
            //
            // pointer 0 = Zoom
            // pointer 1 = analog
            // pointer 2 = camera
            //
            // Consuming the complete MOVE would also block pointer 1/2.
            //
            // The raw hook will selectively remove only the Zoom pointer.
            //
        ...
        case kActionPointerUp:
        {
            ...
            if (
                ...
                // =============================================================
                //
                // Minecraft did not receive this pointer's DOWN.
                //
                // Do not give Minecraft an orphan UP either.
                //
        ...
        case kActionCancel:
        {
            ...
            // CANCEL can also belong to normal Minecraft pointers,
...
// =============================================================================
// RAW POINTER PROCESSING
// =============================================================================
//
// BetterZoom-style filtering:
//
// 1. Find exactly the pointer ID that owns Zoom.
// 2. Read its Y for Zoom in/out.
// 3. Remove ONLY that pointer record.
// 4. Decrement pointerCount.
//
// Other fingers remain untouched.
//
...
void ZoomModule::processRawMotion(
    ...
    for (
        ...
        // =====================================================================
        // REMOVE ZOOM POINTER FROM MINECRAFT EVENT
        // =====================================================================
